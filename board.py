            ...
            for row in range(self.rows):
                if not visited[row][col] :
                    ...
                    if self.board[row][col]!=None:
                        ...
                        # print(tmp_ball_count,tmp_ball_count**2/9)
        # print(ball_score,ball_count)
        return ball_score/ball_count
    def cpmpute_scroce_loss2(self):
        # 評估剩餘版面潛力
        dic={}
        ball_count = 0
        combo_count = 0
        ...
        for item in dic:
            if dic[item]>=3:
                # print(item,dic[item],dic[item]//3)
                ball_count += dic[item]
